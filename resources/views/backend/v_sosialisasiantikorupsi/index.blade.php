...
@section('content_title', 'Sosialisasi Antikorupsi')
@section('content')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="card-title">Sosialisasi Antikorupsi</h4>
                ...
                <tbody>
                    @forelse($data as $key => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('sosialisasiantikorupsi.edit', $item->id) }}" 
                                   class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                <form action="{{ route('sosialisasiantikorupsi.destroy', $item->id) }}" 
