...
<div class="section-header">
    <h1>Edit Sosialisasi Antikorupsi</h1>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="{{ route('sosialisasiantikorupsi.update', $data->id) }}" method="POST">
            ...
            {{-- ========================= --}}
            <h5 class="mb-2"><b>1. Indeks Penilaian Sosialisasi Antikorupsi</b></h5>
            ...
            <table class="table table-bordered" style="background:#dbe5f1;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Jumlah kegiatan Sosialisasi Antikorupsi dalam satu tahun</td>
                    </tr>
                    <tr>
            ...
            <table class="table table-bordered" style="background:#fff2cc;">
                ...
                <tbody>
                    <tr>
                        <td class="text-center">
                            <select name="jenis_kegiatan" id="kegiatan" class="form-control form-control-sm" required>
                                <option value="">-- Pilih --</option>
                                <option value="1">Sosankor Internal</option>
                                <option value="2">Sosankor Eksternal</option>
                                <option value="3">Integrity Sharing</option>
                            </select>
                        </td>
                ...
                <tbody>
                    <tr>
                       <td class="text-center">
                        ...
                        <td class="text-center">
                            <select name="jumlah_peserta" id="internal" class="form-control form-control-sm" required>
                                <option value="">-- Pilih --</option>
            ...
            <a href="{{ route('sosialisasiantikorupsi.index') }}" class="btn btn-secondary">Kembali</a>
