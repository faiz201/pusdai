...
<div class="section-header">
    <h1>Indeks Edukasi Pencegahan Pelanggaran Pegawai</h1>
</div>

<div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0">Rekapitulasi Indeks Edukasi Pencegahan Pelanggaran Pegawai</h5>
    <div>
        <a href="{{ route('edukasi.export.excel') }}" class="btn btn-success btn-sm">
                ...
                <table class="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $d->keterangan ?? '-' }}</td>
                            <td>
                                <a href="{{ route('edukasi.edit', $d->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('edukasi.destroy', $d->id) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
